...
const VERY_POSITIVE_THRESHOLD = 0.65;
const POSITIVE_THRESHOLD = 0.05;
const NEGATIVE_THRESHOLD = -0.05;
const VERY_NEGATIVE_THRESHOLD = -0.65;
...
const B_DECR = -0.293;
const C_INCR = 0.733;
const BARE_AFFIRMATIVE_OR_NEGATIVE = /^(yes|no)(?:\s*[.!?])*\s*$/i;
...
export function isInsufficientContextResponse(text) {
  return typeof text === "string" && BARE_AFFIRMATIVE_OR_NEGATIVE.test(text.trim());
}
