  ...
  return (
    <section className="glass-card p-4 sm:p-5">
      <div className="mb-4">
        ...
        <h3 className="text-xl font-bold text-black mt-2">{building.label}</h3>
        <p className="text-sm text-black mt-1">{building.description}</p>
      </div>

      {floors.length === 0 ? (
        <div className="rounded-2xl border border-dark/10 bg-dark/5 p-5 text-sm text-black">
